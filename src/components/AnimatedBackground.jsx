...
export default function AnimatedBackground({ variant = 'default' }) {
  ...
  // Deterministic-ish particle field (regenerated per mount)
  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      {/* Slowly rotating conic gradient — barely visible, adds motion life */}
      <div
      ...
      {/* Animated orbs */}
      <div
        className="ab-orb-a absolute top-[-10%] left-[-10%] w-[520px] h-[520px] rounded-full blur-[130px]"
        style={{ background: `rgba(${ACCENT_RGB},0.08)` }}
      />
      <div
        className="ab-orb-b absolute bottom-[-10%] right-[-8%] w-[480px] h-[480px] rounded-full blur-[120px]"
      ...
      {/* Diagonal light streaks — shooting stars */}
      {streaks.map((s, i) => (
        <span
          key={i}
